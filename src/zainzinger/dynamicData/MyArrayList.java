...
public class MyArrayList {
	...
	/**
	 * Gibt die aktuelle anzahl an EintrŠgen zurŸck.
	 * @return Die anzahl der EintrŠge
	 */
	public int size(){
		return this.index;//Gibt die Anzahl der Eintrage zurŸck
	}
	
	/**
	 * Lšscht einen bestimmten Eintrag aus der Liste.
	 * @param o Das Objekt, welches gelšscht werden soll
	 * @return Ob das Objekt erfolgreich gelšscht wurde
	 */
	public boolean remove(Object o){
		if(this.contains(o)){//Kontrolliert, ob es das Objekt gibt
			remove(this.indexOf(o));//Lšscht das Objekt
			return true;
		}else{
			return false;//Das Objekt wurde nicht gelšscht
		}
	}
	
	/**
	 * Gibt den letzten Index eines gesuchten Objekts zurŸck
	 * @param o Das gesuchte Objekt
	 * @return Der Index des gesuchten Objekts
	 */
	public int lastIndexOf(Object o){
		for(int i=this.index-1;i>=0;i--){//Geht alle ListeneintrŠge durch und sucht nach dem Objekt
			if(o.equals(this.get(i))){//Vergleicht das Objekt am aktuellen Index und das gesuchte Objekt
				return i;//Gibt den Index zurŸck
			}
		}
